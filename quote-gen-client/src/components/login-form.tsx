...
// Kiểu props cho LoginForm: cho phép App truyền hàm để chuyển sang màn hình Đăng ký
...
const Login: React.FC<LoginFormProps> = ({ onSwitchToSignup, onSwitchToForgot }) => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Tắt trạng thái loading sau khi hoàn thành
      setIsLoading(false);
    }
  };
    ...
    <div className="relative w-full flex items-center justify-center font-sans overflow-hidden">
      ...
      <div className="relative w-full max-w-sm p-6 space-y-6 bg-white dark:bg-black rounded-lg border border-zinc-200 dark:border-zinc-800 shadow-lg dark:shadow-zinc-900/50">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <button
                ...
                disabled={isLoading}
                className="absolute right-3 top-1/2 -translate-y-1/2 hover:text-zinc-900 dark:hover:text-zinc-100 transition-colors disabled:opacity-50"
              >
        ...
        <div className="text-center space-y-2">
          ...
          <button onClick={onSwitchToForgot} className="text-sm font-medium text-zinc-900 dark:text-zinc-50 underline underline-offset-4 hover:text-zinc-700 dark:hover:text-zinc-300 transition-colors">
